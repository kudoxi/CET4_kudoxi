...
use Think\Db;
use think\Session;
require_once $_SERVER['DOCUMENT_ROOT'].'/kudoxi/extend/PHPExcel/Writer/Excel5.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/kudoxi/extend/PHPExcel/Writer/Excel2007.php';
	...
	function excelpost(){
	    ...
	    if(!empty($_FILES['file_stu']['name'])){
		    ...
		    if(strtolower($file_type)!= "xlsx" && strtolower ( $file_type ) != "xls"){
	   		...
	   		//设置上传路径
	     	$savePath = $_SERVER['DOCUMENT_ROOT'].'/kudoxi/public/uploads/';
	     	//以时间来命名上传的文件
	     	$str = date ( 'Ymdhis' ); 
	    ...
	    if($res != 0){
	    	$this->success("导入成功",url("kudoxi/map/map2"));
	    }else{
	    	$this->error("导入失败");
	    }
	}
